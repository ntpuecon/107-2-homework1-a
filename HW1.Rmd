...
「經原PR」可能會與「可修個體」有關聯，並影響立足點的差異。「經原PR」愈高的學生，愈有可能是個經沒被擋修過的學生（可修個體= 1），他的立足點應該比較高。因此若加入「經原PR」這個解釋變數，可以使立足點的差異轉移到「經原PR」下。且若「經原PR」較高，通常也代表「個經PR」較高，所以有必要控制「經原PR」這個解釋變數。
