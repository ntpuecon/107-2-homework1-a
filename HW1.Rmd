...
model1HW_coeftest<- coeftest(model1, vcov. = vcovHC, type="HC1")
...
故若不控制**經原PR**，因**可修個體**=1與=0兩群人也會分別帶有 **經原PR**  (7)__高與低__(高與低/低與高)特質，所以**可修個體**=1的人其**個經PR**高，有部份是因其**經原PR**也較(8)_高___(高/低)所至。
