...
$$<1>{\sum(x_i-\bar{x})(y_i-\bar{y})}$$
$$=\sum(x_i-\bar{x})y_i$$
$$=\sum{x_iy_i}-\sum{\bar{x}y_i}$$
$$=n\bar{y_i}-\frac{n_1}{n_0+n_1}\sum{y_i}$$
$$=n_1\bar{y_1}-\frac{n_1}{n_0+n_1}(n_0\bar{y_0}+n_1\bar{y_1})$$
...
$$<2>\sum(x_i-\bar{x})^2$$
$$=\sum{x_i}^2-n\bar{x}^2$$
$$=n_1-n(\frac{n_1}{n_0+n_1})^2$$
$$=n_1-(n_0+n_1)\frac{n_1^2}{(n_0+n_1)^2}$$
